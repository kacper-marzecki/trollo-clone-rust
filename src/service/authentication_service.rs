...
pub fn create_jwt(private_claim: PrivateClaim) -> Result<String, AppError> {
    ...
    encode(
        ...
        .map_err(|e| AppError::CannotEncodeJwtToken(e.to_string()))
}

/// Decode a json web token (JWT)
pub fn decode_jwt(token: &str) -> Result<PrivateClaim, AppError> {
    ...
    decode::<PrivateClaim>(token, &decoding_key, &Validation::default())
        ...
        .map_err(|e| AppError::CannotDecodeJwtToken(e.to_string()))
}
